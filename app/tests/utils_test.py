from app.endpoints.utils import check_horizontal_genes, check_vertical_genes, check_diagonal_genes, \
    check_reversed_diagonal_genes, parse_list
...
def test_parse_list():
    assert parse_list(["ABCDEF", "GHIJKL", "MNOPQR", "STUVXZ", "123456", "789ABC"]) == ["ABCDEF", "GHIJKL", "MNOPQR",
                                                                                        "STUVXZ", "123456", "789ABC"]
